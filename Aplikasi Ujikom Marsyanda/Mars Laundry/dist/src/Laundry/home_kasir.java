            ...
            public void run (){
                try{
                    for(int a=0;a<=14;a++){
                        ...
                        if (a==10){pHome.setText("Welcome To K");}
                        if (a==11){pHome.setText("Welcome To Ka");}
                        if (a==12){pHome.setText("Welcome To Kas");}
                        if (a==13){pHome.setText("Welcome To Kasi");}
                        if (a==14){pHome.setText("Welcome To Kasir");}
                    }
                }catch (Exception ex){
...
public void tampiltabelbaru(){
    ...
    private void initComponents() {
        ...
        menu_member = new javax.swing.JMenu();
        menu_order_masuk = new javax.swing.JMenu();
        ...
        jPanel1.setMinimumSize(new java.awt.Dimension(942, 440));
        ...
        dashboard.add(jScrollPane14, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 610, 240));
        ...
        progresspnl.setMinimumSize(new java.awt.Dimension(726, 334));
        ...
        ambilpnl.add(jScrollPane11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 79, 411, 200));
        ...
        ambilpnl.add(jScrollPane12, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 246, 216, 100));
        ...
        ambilpnl.add(add2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 290, 90, 40));
        ...
        ambilpnl.add(add3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 290, 90, 40));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                    ...
                    .addComponent(mainprogpnl, javax.swing.GroupLayout.PREFERRED_SIZE, 758, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap()))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                    ...
                    .addComponent(mainprogpnl, javax.swing.GroupLayout.PREFERRED_SIZE, 351, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pHome.setText("-");
        jPanel1.add(pHome, new org.netbeans.lib.awtextra.AbsoluteConstraints(305, 14, 610, 40));

        Clock.setFont(new java.awt.Font("Engravers MT", 1, 17)); // NOI18N
        Clock.setForeground(new java.awt.Color(255, 255, 255));
        Clock.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Clock.setText("0 : 29 : 10 PM");
        jPanel1.add(Clock, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 30, 160, -1));
        ...
        jPanel1.add(tanggal, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 20, 258, 40));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 420, 140, 49));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 3, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Jenis Laundry :");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 350, 100, 40));

        jLabel5.setFont(new java.awt.Font("Times New Roman", 3, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Jl.Galanggang Ds.Neglasari Kec.Batujajar Kab.Bandung Barat");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 470, 380, 28));

        jLabel6.setFont(new java.awt.Font("Times New Roman", 3, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("=> Cucian Kiloan");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 360, 120, 20));

        jLabel7.setFont(new java.awt.Font("Times New Roman", 3, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("=> Selimut ");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 380, 110, 20));

        jLabel8.setFont(new java.awt.Font("Times New Roman", 3, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("=> Bed Cover");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 400, 110, 20));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 3, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("=> Kaos");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 420, 110, 20));

        jLabel10.setFont(new java.awt.Font("Times New Roman", 3, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("=> DLL.");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 440, 110, 20));

        jLabel11.setFont(new java.awt.Font("Times New Roman", 3, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Mars Launry Stor");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 330, 110, 30));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Laundry/icon/kal.png"))); // NOI18N
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 60, 60));
        ...
        jLabel1.setPreferredSize(new java.awt.Dimension(1195, 550));
        ...
        menu_member.setText("Registrasi Member           ");
        menu_member.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                menu_memberMousePressed(evt);
            }
        });
        jMenuBar1.add(menu_member);

        menu_order_masuk.setText("Data Transakasi           ");
        menu_order_masuk.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                menu_order_masukMousePressed(evt);
            }
        });
        jMenuBar1.add(menu_order_masuk);
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 1195, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void menu_memberMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menu_memberMousePressed
        this.setVisible(true);
        new menu_member().setVisible(true);
    }//GEN-LAST:event_menu_memberMousePressed

    private void menu_order_masukMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menu_order_masukMousePressed
        this.setVisible(true);
        new menu_transaksi().setVisible(true);
    }//GEN-LAST:event_menu_order_masukMousePressed
...
dispose();
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
       ...
       con.close();
        ...
        Logger.getLogger(home_kasir.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private javax.swing.JMenu menu_member;
    private javax.swing.JMenu menu_order_masuk;
